...
internal object SmileysAndPeopleCategoryChunk1 {
  internal val EMOJIS: List<GoogleCompatEmoji> = listOf(
    ...
    GoogleCompatEmoji("\ud83d\ude20", listOf("angry")),
    GoogleCompatEmoji("\ud83e\udd2c", listOf("face_with_symbols_on_mouth", "serious_face_with_symbols_covering_mouth")),
    ...
    GoogleCompatEmoji("\ud83d\udc7a", listOf("japanese_goblin")),
    GoogleCompatEmoji("\ud83d\udc7b", listOf("ghost")),
    GoogleCompatEmoji("\ud83d\udc7d", listOf("alien")),
    GoogleCompatEmoji("\ud83d\udc7e", listOf("space_invader")),
    GoogleCompatEmoji("\ud83e\udd16", listOf("robot_face")),
    GoogleCompatEmoji("\ud83d\ude3a", listOf("smiley_cat")),
    GoogleCompatEmoji("\ud83d\ude38", listOf("smile_cat")),
    GoogleCompatEmoji("\ud83d\ude39", listOf("joy_cat")),
    GoogleCompatEmoji("\ud83d\ude3b", listOf("heart_eyes_cat")),
    GoogleCompatEmoji("\ud83d\ude3c", listOf("smirk_cat")),
    GoogleCompatEmoji("\ud83d\ude3d", listOf("kissing_cat")),
    GoogleCompatEmoji("\ud83d\ude40", listOf("scream_cat")),
    GoogleCompatEmoji("\ud83d\ude3f", listOf("crying_cat_face")),
    GoogleCompatEmoji("\ud83d\ude3e", listOf("pouting_cat")),
    GoogleCompatEmoji("\ud83d\ude48", listOf("see_no_evil")),
    GoogleCompatEmoji("\ud83d\ude49", listOf("hear_no_evil")),
    GoogleCompatEmoji("\ud83d\ude4a", listOf("speak_no_evil")),
    GoogleCompatEmoji("\ud83d\udc8c", listOf("love_letter")),
    GoogleCompatEmoji("\ud83d\udc98", listOf("cupid")),
    GoogleCompatEmoji("\ud83d\udc9d", listOf("gift_heart")),
    GoogleCompatEmoji("\ud83d\udc96", listOf("sparkling_heart")),
    GoogleCompatEmoji("\ud83d\udc97", listOf("heartpulse")),
    GoogleCompatEmoji("\ud83d\udc93", listOf("heartbeat")),
    ...
    GoogleCompatEmoji("\ud83d\udc9a", listOf("green_heart")),
    GoogleCompatEmoji("\ud83d\udc99", listOf("blue_heart")),
    GoogleCompatEmoji("\ud83e\ude75", listOf("light_blue_heart")),
    GoogleCompatEmoji("\ud83d\udc9c", listOf("purple_heart")),
    GoogleCompatEmoji("\ud83e\udd0e", listOf("brown_heart")),
    GoogleCompatEmoji("\ud83d\udda4", listOf("black_heart")),
    GoogleCompatEmoji("\ud83e\ude76", listOf("grey_heart")),
    GoogleCompatEmoji("\ud83e\udd0d", listOf("white_heart")),
    GoogleCompatEmoji("\ud83d\udc8b", listOf("kiss")),
    GoogleCompatEmoji("\ud83d\udcaf", listOf("100")),
    GoogleCompatEmoji("\ud83d\udca2", listOf("anger")),
    GoogleCompatEmoji("\ud83d\udca5", listOf("boom", "collision")),
