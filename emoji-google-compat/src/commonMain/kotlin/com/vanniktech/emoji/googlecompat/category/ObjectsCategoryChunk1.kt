...
internal object ObjectsCategoryChunk1 {
  internal val EMOJIS: List<GoogleCompatEmoji> = listOf(
    ...
    GoogleCompatEmoji("\ud83d\udcf9", listOf("video_camera")),
    ...
    GoogleCompatEmoji("\ud83e\ude94", listOf("diya_lamp")),
    GoogleCompatEmoji("\ud83d\udcd4", listOf("notebook_with_decorative_cover")),
    GoogleCompatEmoji("\ud83d\udcd5", listOf("closed_book")),
    GoogleCompatEmoji("\ud83d\udcd6", listOf("book", "open_book")),
    GoogleCompatEmoji("\ud83d\udcd7", listOf("green_book")),
    GoogleCompatEmoji("\ud83d\udcd8", listOf("blue_book")),
    GoogleCompatEmoji("\ud83d\udcd9", listOf("orange_book")),
    GoogleCompatEmoji("\ud83d\udcda", listOf("books")),
    GoogleCompatEmoji("\ud83d\udcd3", listOf("notebook")),
    GoogleCompatEmoji("\ud83d\udcd2", listOf("ledger")),
    GoogleCompatEmoji("\ud83d\udcc3", listOf("page_with_curl")),
    ...
    GoogleCompatEmoji("\ud83d\udcb5", listOf("dollar")),
    GoogleCompatEmoji("\ud83d\udcb6", listOf("euro")),
    GoogleCompatEmoji("\ud83d\udcb7", listOf("pound")),
    GoogleCompatEmoji("\ud83d\udcb8", listOf("money_with_wings")),
    ...
    GoogleCompatEmoji("\ud83d\udce4", listOf("outbox_tray")),
    GoogleCompatEmoji("\ud83d\udce5", listOf("inbox_tray")),
    GoogleCompatEmoji("\ud83d\udce6", listOf("package")),
    GoogleCompatEmoji("\ud83d\udceb", listOf("mailbox")),
    GoogleCompatEmoji("\ud83d\udcea", listOf("mailbox_closed")),
    ...
    GoogleCompatEmoji("\ud83d\udcca", listOf("bar_chart")),
    GoogleCompatEmoji("\ud83d\udccb", listOf("clipboard")),
