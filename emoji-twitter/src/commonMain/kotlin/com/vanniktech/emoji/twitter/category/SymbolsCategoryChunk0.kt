...
internal object SymbolsCategoryChunk0 {
  internal val EMOJIS: List<TwitterEmoji> = listOf(
    TwitterEmoji(String(intArrayOf(0x1F3E7), 0, 1), listOf("atm"), 10, 28, false),
    TwitterEmoji(String(intArrayOf(0x1F6AE), 0, 1), listOf("put_litter_in_its_place"), 36, 58, false),
    TwitterEmoji(String(intArrayOf(0x1F6B0), 0, 1), listOf("potable_water"), 36, 60, false),
    TwitterEmoji(String(intArrayOf(0x267F), 0, 1), listOf("wheelchair"), 58, 56, false),
    TwitterEmoji(String(intArrayOf(0x1F6B9), 0, 1), listOf("mens"), 38, 14, false),
    TwitterEmoji(String(intArrayOf(0x1F6BA), 0, 1), listOf("womens"), 38, 15, false),
    TwitterEmoji(String(intArrayOf(0x1F6BB), 0, 1), listOf("restroom"), 38, 16, false),
    TwitterEmoji(String(intArrayOf(0x1F6BC), 0, 1), listOf("baby_symbol"), 38, 17, false),
    TwitterEmoji(String(intArrayOf(0x1F6BE), 0, 1), listOf("wc"), 38, 19, false),
    TwitterEmoji(String(intArrayOf(0x1F6C2), 0, 1), listOf("passport_control"), 38, 28, false),
    ...
    TwitterEmoji(String(intArrayOf(0x1F6B3), 0, 1), listOf("no_bicycles"), 37, 1, false),
    TwitterEmoji(String(intArrayOf(0x1F6AD), 0, 1), listOf("no_smoking"), 36, 57, false),
    TwitterEmoji(String(intArrayOf(0x1F6AF), 0, 1), listOf("do_not_litter"), 36, 59, false),
    TwitterEmoji(String(intArrayOf(0x1F6B1), 0, 1), listOf("non-potable_water"), 36, 61, false),
    ...
    TwitterEmoji(String(intArrayOf(0x1F51A), 0, 1), listOf("end"), 30, 18, false),
    TwitterEmoji(String(intArrayOf(0x1F51B), 0, 1), listOf("on"), 30, 19, false),
    ...
    TwitterEmoji(String(intArrayOf(0x2648), 0, 1), listOf("aries"), 58, 36, false),
    TwitterEmoji(String(intArrayOf(0x2649), 0, 1), listOf("taurus"), 58, 37, false),
    TwitterEmoji(String(intArrayOf(0x264A), 0, 1), listOf("gemini"), 58, 38, false),
    TwitterEmoji(String(intArrayOf(0x264B), 0, 1), listOf("cancer"), 58, 39, false),
    TwitterEmoji(String(intArrayOf(0x264C), 0, 1), listOf("leo"), 58, 40, false),
    TwitterEmoji(String(intArrayOf(0x264D), 0, 1), listOf("virgo"), 58, 41, false),
    TwitterEmoji(String(intArrayOf(0x264E), 0, 1), listOf("libra"), 58, 42, false),
    TwitterEmoji(String(intArrayOf(0x264F), 0, 1), listOf("scorpius"), 58, 43, false),
    TwitterEmoji(String(intArrayOf(0x2650), 0, 1), listOf("sagittarius"), 58, 44, false),
    TwitterEmoji(String(intArrayOf(0x2651), 0, 1), listOf("capricorn"), 58, 45, false),
    TwitterEmoji(String(intArrayOf(0x2652), 0, 1), listOf("aquarius"), 58, 46, false),
    TwitterEmoji(String(intArrayOf(0x2653), 0, 1), listOf("pisces"), 58, 47, false),
    TwitterEmoji(String(intArrayOf(0x26CE), 0, 1), listOf("ophiuchus"), 59, 16, false),
    ...
    TwitterEmoji(String(intArrayOf(0x1F4F6), 0, 1), listOf("signal_strength"), 29, 45, false),
