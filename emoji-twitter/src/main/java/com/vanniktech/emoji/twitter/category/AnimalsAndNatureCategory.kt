...
internal class AnimalsAndNatureCategory : EmojiCategory {
  @get:DrawableRes override val icon: Int
    get() = com.vanniktech.emoji.twitter.R.drawable.emoji_twitter_category_animalsandnature

  @get:StringRes override val categoryName: Int
    get() = com.vanniktech.emoji.twitter.R.string.emoji_twitter_category_animalsandnature

  override val emojis = ALL_EMOJIS

  private companion object {
    val ALL_EMOJIS: Array<TwitterEmoji> = CategoryUtils.concatAll(AnimalsAndNatureCategoryChunk0.get())
  }
}
