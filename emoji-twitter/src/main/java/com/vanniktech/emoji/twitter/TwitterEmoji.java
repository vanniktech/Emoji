...
public class TwitterEmoji extends Emoji {
  ...
  public TwitterEmoji(@NonNull final int[] codePoints, @Nullable final String shortcode, final int x, final int y,
  ...
  public TwitterEmoji(final int codePoint, @Nullable final String shortcode, final int x, final int y,
                     final boolean isDuplicate) {
