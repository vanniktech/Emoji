...
internal class ActivitiesCategory : EmojiCategory {
  ...
  @get:StringRes override val categoryName: Int
    get() = com.vanniktech.emoji.twitter.R.string.emoji_twitter_category_activities

  override val emojis = ALL_EMOJIS

  private companion object {
    val ALL_EMOJIS: Array<TwitterEmoji> = CategoryUtils.concatAll(ActivitiesCategoryChunk0.get())
  }
}
