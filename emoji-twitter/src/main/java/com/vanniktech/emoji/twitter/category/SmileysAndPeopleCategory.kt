...
internal class SmileysAndPeopleCategory : EmojiCategory {
  ...
  @get:StringRes override val categoryName: Int
    get() = com.vanniktech.emoji.twitter.R.string.emoji_twitter_category_smileysandpeople

  override val emojis = ALL_EMOJIS

  private companion object {
    val ALL_EMOJIS: Array<TwitterEmoji> = CategoryUtils.concatAll(SmileysAndPeopleCategoryChunk0.get(), SmileysAndPeopleCategoryChunk1.get(), SmileysAndPeopleCategoryChunk2.get())
  }
}
