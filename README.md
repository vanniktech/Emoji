...
```groovy
implementation("com.vanniktech:emoji:0.24.1-SNAPSHOT")
implementation("com.vanniktech:emoji-ios:0.24.1-SNAPSHOT")
implementation("com.vanniktech:emoji-google:0.24.1-SNAPSHOT")
implementation("com.vanniktech:emoji-google-compat:0.24.1-SNAPSHOT")
implementation("com.vanniktech:emoji-androidx-emoji2:0.24.1-SNAPSHOT")
implementation("com.vanniktech:emoji-twitter:0.24.1-SNAPSHOT")
implementation("com.vanniktech:emoji-facebook:0.24.1-SNAPSHOT")
implementation("com.vanniktech:emoji-material:0.24.1-SNAPSHOT")
```
