...
```groovy
implementation("com.vanniktech:emoji-facebook:0.23.0")
```
...
```groovy
implementation("com.vanniktech:emoji-google-compat:0.23.0")
```
...
```groovy
implementation("com.vanniktech:emoji-androidx-emoji2:0.23.0")
```
...
```groovy
implementation("com.vanniktech:emoji:0.23.0")
```
