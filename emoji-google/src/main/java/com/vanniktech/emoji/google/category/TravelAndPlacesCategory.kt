...
internal class TravelAndPlacesCategory : EmojiCategory {
  @get:DrawableRes override val icon: Int
    get() = com.vanniktech.emoji.google.R.drawable.emoji_google_category_travelandplaces

  @get:StringRes override val categoryName: Int
    get() = com.vanniktech.emoji.google.R.string.emoji_google_category_travelandplaces
