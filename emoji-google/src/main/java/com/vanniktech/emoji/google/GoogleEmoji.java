...
public class GoogleEmoji extends Emoji {
  ...
  public GoogleEmoji(@NonNull final int[] codePoints, @Nullable final String shortcode, final int x, final int y,
  ...
  public GoogleEmoji(final int codePoint, @Nullable final String shortcode, final int x, final int y,
                     final boolean isDuplicate) {
