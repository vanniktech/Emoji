...
@SuppressWarnings("PMD.MethodReturnsInternalArray") public final class FlagsCategory implements EmojiCategory {
  private static final Emoji[] DATA = new Emoji[] {
    ...
    new Emoji(new int[] { 0x1f1e6, 0x1f1e8 }, R.drawable.emoji_google_1f1e6_1f1e8),
    new Emoji(new int[] { 0x1f1f9, 0x1f1e6 }, R.drawable.emoji_google_1f1f9_1f1e6),
    new Emoji(new int[] { 0x1f1e7, 0x1f1fb }, R.drawable.emoji_google_1f1e7_1f1fb),
    new Emoji(new int[] { 0x1f1ed, 0x1f1f2 }, R.drawable.emoji_google_1f1ed_1f1f2),
    new Emoji(new int[] { 0x1f1f8, 0x1f1ef }, R.drawable.emoji_google_1f1f8_1f1ef),
    new Emoji(new int[] { 0x1f1fa, 0x1f1f2 }, R.drawable.emoji_google_1f1fa_1f1f2),
    new Emoji(new int[] { 0x1f1e8, 0x1f1f5 }, R.drawable.emoji_google_1f1e8_1f1f5)
  };
