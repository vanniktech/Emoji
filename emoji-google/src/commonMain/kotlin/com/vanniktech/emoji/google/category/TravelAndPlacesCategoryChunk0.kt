...
internal object TravelAndPlacesCategoryChunk0 {
  internal val EMOJIS: List<GoogleEmoji> = listOf(
    GoogleEmoji(String(intArrayOf(0x1F30D), 0, 1), listOf("earth_africa"), 5, 7, false),
    ...
    GoogleEmoji(String(intArrayOf(0x1F3E3), 0, 1), listOf("post_office"), 10, 24, false),
    GoogleEmoji(String(intArrayOf(0x1F3E4), 0, 1), listOf("european_post_office"), 10, 25, false),
    GoogleEmoji(String(intArrayOf(0x1F3E5), 0, 1), listOf("hospital"), 10, 26, false),
    GoogleEmoji(String(intArrayOf(0x1F3E6), 0, 1), listOf("bank"), 10, 27, false),
    GoogleEmoji(String(intArrayOf(0x1F3E8), 0, 1), listOf("hotel"), 10, 29, false),
    GoogleEmoji(String(intArrayOf(0x1F3E9), 0, 1), listOf("love_hotel"), 10, 30, false),
    GoogleEmoji(String(intArrayOf(0x1F3EA), 0, 1), listOf("convenience_store"), 10, 31, false),
    GoogleEmoji(String(intArrayOf(0x1F3EB), 0, 1), listOf("school"), 10, 32, false),
    GoogleEmoji(String(intArrayOf(0x1F3EC), 0, 1), listOf("department_store"), 10, 33, false),
    GoogleEmoji(String(intArrayOf(0x1F3ED), 0, 1), listOf("factory"), 10, 34, false),
    GoogleEmoji(String(intArrayOf(0x1F3EF), 0, 1), listOf("japanese_castle"), 10, 36, false),
    GoogleEmoji(String(intArrayOf(0x1F3F0), 0, 1), listOf("european_castle"), 10, 37, false),
    GoogleEmoji(String(intArrayOf(0x1F492), 0, 1), listOf("wedding"), 28, 2, false),
    GoogleEmoji(String(intArrayOf(0x1F5FC), 0, 1), listOf("tokyo_tower"), 32, 42, false),
    GoogleEmoji(String(intArrayOf(0x1F5FD), 0, 1), listOf("statue_of_liberty"), 32, 43, false),
    GoogleEmoji(String(intArrayOf(0x26EA), 0, 1), listOf("church"), 59, 23, false),
    ...
    GoogleEmoji(String(intArrayOf(0x1F3A2), 0, 1), listOf("roller_coaster"), 7, 32, false),
    GoogleEmoji(String(intArrayOf(0x1F488), 0, 1), listOf("barber"), 27, 4, false),
    GoogleEmoji(String(intArrayOf(0x1F3AA), 0, 1), listOf("circus_tent"), 7, 40, false),
    GoogleEmoji(String(intArrayOf(0x1F682), 0, 1), listOf("steam_locomotive"), 35, 59, false),
    GoogleEmoji(String(intArrayOf(0x1F683), 0, 1), listOf("railway_car"), 35, 60, false),
    GoogleEmoji(String(intArrayOf(0x1F684), 0, 1), listOf("bullettrain_side"), 35, 61, false),
    GoogleEmoji(String(intArrayOf(0x1F685), 0, 1), listOf("bullettrain_front"), 36, 0, false),
    GoogleEmoji(String(intArrayOf(0x1F686), 0, 1), listOf("train2"), 36, 1, false),
    GoogleEmoji(String(intArrayOf(0x1F687), 0, 1), listOf("metro"), 36, 2, false),
    GoogleEmoji(String(intArrayOf(0x1F688), 0, 1), listOf("light_rail"), 36, 3, false),
    GoogleEmoji(String(intArrayOf(0x1F689), 0, 1), listOf("station"), 36, 4, false),
    GoogleEmoji(String(intArrayOf(0x1F68A), 0, 1), listOf("tram"), 36, 5, false),
    GoogleEmoji(String(intArrayOf(0x1F69D), 0, 1), listOf("monorail"), 36, 24, false),
    GoogleEmoji(String(intArrayOf(0x1F69E), 0, 1), listOf("mountain_railway"), 36, 25, false),
    GoogleEmoji(String(intArrayOf(0x1F68B), 0, 1), listOf("train"), 36, 6, false),
    GoogleEmoji(String(intArrayOf(0x1F68C), 0, 1), listOf("bus"), 36, 7, false),
    GoogleEmoji(String(intArrayOf(0x1F68D), 0, 1), listOf("oncoming_bus"), 36, 8, false),
    GoogleEmoji(String(intArrayOf(0x1F68E), 0, 1), listOf("trolleybus"), 36, 9, false),
    GoogleEmoji(String(intArrayOf(0x1F690), 0, 1), listOf("minibus"), 36, 11, false),
    GoogleEmoji(String(intArrayOf(0x1F691), 0, 1), listOf("ambulance"), 36, 12, false),
    GoogleEmoji(String(intArrayOf(0x1F692), 0, 1), listOf("fire_engine"), 36, 13, false),
    GoogleEmoji(String(intArrayOf(0x1F693), 0, 1), listOf("police_car"), 36, 14, false),
    GoogleEmoji(String(intArrayOf(0x1F694), 0, 1), listOf("oncoming_police_car"), 36, 15, false),
    GoogleEmoji(String(intArrayOf(0x1F695), 0, 1), listOf("taxi"), 36, 16, false),
    GoogleEmoji(String(intArrayOf(0x1F696), 0, 1), listOf("oncoming_taxi"), 36, 17, false),
    GoogleEmoji(String(intArrayOf(0x1F697), 0, 1), listOf("car", "red_car"), 36, 18, false),
    GoogleEmoji(String(intArrayOf(0x1F698), 0, 1), listOf("oncoming_automobile"), 36, 19, false),
    GoogleEmoji(String(intArrayOf(0x1F699), 0, 1), listOf("blue_car"), 36, 20, false),
    GoogleEmoji(String(intArrayOf(0x1F6FB), 0, 1), listOf("pickup_truck"), 39, 8, false),
    ...
    GoogleEmoji(String(intArrayOf(0x1F6FA), 0, 1), listOf("auto_rickshaw"), 39, 7, false),
    GoogleEmoji(String(intArrayOf(0x1F6B2), 0, 1), listOf("bike"), 37, 0, false),
    GoogleEmoji(String(intArrayOf(0x1F6F4), 0, 1), listOf("scooter"), 39, 1, false),
    ...
    GoogleEmoji(String(intArrayOf(0x1F6A5), 0, 1), listOf("traffic_light"), 36, 49, false),
    GoogleEmoji(String(intArrayOf(0x1F6A6), 0, 1), listOf("vertical_traffic_light"), 36, 50, false),
    GoogleEmoji(String(intArrayOf(0x1F6D1), 0, 1), listOf("octagonal_sign"), 38, 43, false),
    GoogleEmoji(String(intArrayOf(0x1F6A7), 0, 1), listOf("construction"), 36, 51, false),
    GoogleEmoji(String(intArrayOf(0x2693), 0, 1), listOf("anchor"), 58, 58, false),
    GoogleEmoji(String(intArrayOf(0x1F6DF), 0, 1), listOf("ring_buoy"), 38, 51, false),
    GoogleEmoji(String(intArrayOf(0x26F5), 0, 1), listOf("boat", "sailboat"), 59, 29, false),
    GoogleEmoji(String(intArrayOf(0x1F6F6), 0, 1), listOf("canoe"), 39, 3, false),
  )
}
