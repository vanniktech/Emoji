...
internal object TravelAndPlacesCategoryChunk1 {
  internal val EMOJIS: List<GoogleEmoji> = listOf(
    ...
    GoogleEmoji(String(intArrayOf(0x1F6EC), 0, 1), listOf("airplane_arriving"), 38, 60),
    GoogleEmoji(String(intArrayOf(0x1FA82), 0, 1), listOf("parachute"), 55, 3),
    GoogleEmoji(String(intArrayOf(0x1F4BA), 0, 1), listOf("seat"), 28, 47),
    GoogleEmoji(String(intArrayOf(0x1F681), 0, 1), listOf("helicopter"), 35, 58),
    GoogleEmoji(String(intArrayOf(0x1F69F), 0, 1), listOf("suspension_railway"), 36, 26),
    ...
    GoogleEmoji(String(intArrayOf(0x231B), 0, 1), listOf("hourglass"), 57, 44),
    GoogleEmoji(String(intArrayOf(0x23F3), 0, 1), listOf("hourglass_flowing_sand"), 57, 57),
    ...
    GoogleEmoji(String(intArrayOf(0x1F567), 0, 1), listOf("clock1230"), 31, 21),
    GoogleEmoji(String(intArrayOf(0x1F550), 0, 1), listOf("clock1"), 30, 60),
    GoogleEmoji(String(intArrayOf(0x1F55C), 0, 1), listOf("clock130"), 31, 10),
    GoogleEmoji(String(intArrayOf(0x1F551), 0, 1), listOf("clock2"), 30, 61),
    GoogleEmoji(String(intArrayOf(0x1F55D), 0, 1), listOf("clock230"), 31, 11),
    GoogleEmoji(String(intArrayOf(0x1F552), 0, 1), listOf("clock3"), 31, 0),
    GoogleEmoji(String(intArrayOf(0x1F55E), 0, 1), listOf("clock330"), 31, 12),
    GoogleEmoji(String(intArrayOf(0x1F553), 0, 1), listOf("clock4"), 31, 1),
    GoogleEmoji(String(intArrayOf(0x1F55F), 0, 1), listOf("clock430"), 31, 13),
    GoogleEmoji(String(intArrayOf(0x1F554), 0, 1), listOf("clock5"), 31, 2),
    GoogleEmoji(String(intArrayOf(0x1F560), 0, 1), listOf("clock530"), 31, 14),
    GoogleEmoji(String(intArrayOf(0x1F555), 0, 1), listOf("clock6"), 31, 3),
    GoogleEmoji(String(intArrayOf(0x1F561), 0, 1), listOf("clock630"), 31, 15),
    GoogleEmoji(String(intArrayOf(0x1F556), 0, 1), listOf("clock7"), 31, 4),
    GoogleEmoji(String(intArrayOf(0x1F562), 0, 1), listOf("clock730"), 31, 16),
    GoogleEmoji(String(intArrayOf(0x1F557), 0, 1), listOf("clock8"), 31, 5),
    GoogleEmoji(String(intArrayOf(0x1F563), 0, 1), listOf("clock830"), 31, 17),
    GoogleEmoji(String(intArrayOf(0x1F558), 0, 1), listOf("clock9"), 31, 6),
    GoogleEmoji(String(intArrayOf(0x1F564), 0, 1), listOf("clock930"), 31, 18),
    GoogleEmoji(String(intArrayOf(0x1F559), 0, 1), listOf("clock10"), 31, 7),
    GoogleEmoji(String(intArrayOf(0x1F565), 0, 1), listOf("clock1030"), 31, 19),
    GoogleEmoji(String(intArrayOf(0x1F55A), 0, 1), listOf("clock11"), 31, 8),
    GoogleEmoji(String(intArrayOf(0x1F566), 0, 1), listOf("clock1130"), 31, 20),
    GoogleEmoji(String(intArrayOf(0x1F311), 0, 1), listOf("new_moon"), 5, 11),
    GoogleEmoji(String(intArrayOf(0x1F312), 0, 1), listOf("waxing_crescent_moon"), 5, 12),
    GoogleEmoji(String(intArrayOf(0x1F313), 0, 1), listOf("first_quarter_moon"), 5, 13),
    GoogleEmoji(String(intArrayOf(0x1F314), 0, 1), listOf("moon", "waxing_gibbous_moon"), 5, 14),
    GoogleEmoji(String(intArrayOf(0x1F315), 0, 1), listOf("full_moon"), 5, 15),
    GoogleEmoji(String(intArrayOf(0x1F316), 0, 1), listOf("waning_gibbous_moon"), 5, 16),
    GoogleEmoji(String(intArrayOf(0x1F317), 0, 1), listOf("last_quarter_moon"), 5, 17),
    GoogleEmoji(String(intArrayOf(0x1F318), 0, 1), listOf("waning_crescent_moon"), 5, 18),
    GoogleEmoji(String(intArrayOf(0x1F319), 0, 1), listOf("crescent_moon"), 5, 19),
    GoogleEmoji(String(intArrayOf(0x1F31A), 0, 1), listOf("new_moon_with_face"), 5, 20),
    ...
    GoogleEmoji(String(intArrayOf(0x1F31E), 0, 1), listOf("sun_with_face"), 5, 24),
    GoogleEmoji(String(intArrayOf(0x1FA90), 0, 1), listOf("ringed_planet"), 55, 10),
    GoogleEmoji(String(intArrayOf(0x2B50), 0, 1), listOf("star"), 60, 52),
    GoogleEmoji(String(intArrayOf(0x1F31F), 0, 1), listOf("star2"), 5, 25),
