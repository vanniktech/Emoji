...
internal object ObjectsCategoryChunk0 {
  internal val EMOJIS: List<GoogleEmoji> = listOf(
    ...
    GoogleEmoji(String(intArrayOf(0x1F454), 0, 1), listOf("necktie"), 13, 25, false),
    GoogleEmoji(String(intArrayOf(0x1F455), 0, 1), listOf("shirt", "tshirt"), 13, 26, false),
    GoogleEmoji(String(intArrayOf(0x1F456), 0, 1), listOf("jeans"), 13, 27, false),
    GoogleEmoji(String(intArrayOf(0x1F9E3), 0, 1), listOf("scarf"), 54, 21, false),
    GoogleEmoji(String(intArrayOf(0x1F9E4), 0, 1), listOf("gloves"), 54, 22, false),
    GoogleEmoji(String(intArrayOf(0x1F9E5), 0, 1), listOf("coat"), 54, 23, false),
    GoogleEmoji(String(intArrayOf(0x1F9E6), 0, 1), listOf("socks"), 54, 24, false),
    GoogleEmoji(String(intArrayOf(0x1F457), 0, 1), listOf("dress"), 13, 28, false),
    GoogleEmoji(String(intArrayOf(0x1F458), 0, 1), listOf("kimono"), 13, 29, false),
    GoogleEmoji(String(intArrayOf(0x1F97B), 0, 1), listOf("sari"), 44, 48, false),
    GoogleEmoji(String(intArrayOf(0x1FA71), 0, 1), listOf("one-piece_swimsuit"), 54, 51, false),
    GoogleEmoji(String(intArrayOf(0x1FA72), 0, 1), listOf("briefs"), 54, 52, false),
    GoogleEmoji(String(intArrayOf(0x1FA73), 0, 1), listOf("shorts"), 54, 53, false),
    GoogleEmoji(String(intArrayOf(0x1F459), 0, 1), listOf("bikini"), 13, 30, false),
    GoogleEmoji(String(intArrayOf(0x1F45A), 0, 1), listOf("womans_clothes"), 13, 31, false),
    GoogleEmoji(String(intArrayOf(0x1FAAD), 0, 1), listOf("folding_hand_fan"), 55, 39, false),
    ...
    GoogleEmoji(String(intArrayOf(0x1F45F), 0, 1), listOf("athletic_shoe"), 13, 36, false),
    GoogleEmoji(String(intArrayOf(0x1F97E), 0, 1), listOf("hiking_boot"), 44, 51, false),
    GoogleEmoji(String(intArrayOf(0x1F97F), 0, 1), listOf("womans_flat_shoe"), 44, 52, false),
    GoogleEmoji(String(intArrayOf(0x1F460), 0, 1), listOf("high_heel"), 13, 37, false),
    GoogleEmoji(String(intArrayOf(0x1F461), 0, 1), listOf("sandal"), 13, 38, false),
    GoogleEmoji(String(intArrayOf(0x1FA70), 0, 1), listOf("ballet_shoes"), 54, 50, false),
    GoogleEmoji(String(intArrayOf(0x1F462), 0, 1), listOf("boot"), 13, 39, false),
    GoogleEmoji(String(intArrayOf(0x1FAAE), 0, 1), listOf("hair_pick"), 55, 40, false),
    GoogleEmoji(String(intArrayOf(0x1F451), 0, 1), listOf("crown"), 13, 22, false),
    GoogleEmoji(String(intArrayOf(0x1F452), 0, 1), listOf("womans_hat"), 13, 23, false),
    GoogleEmoji(String(intArrayOf(0x1F3A9), 0, 1), listOf("tophat"), 7, 39, false),
    ...
    GoogleEmoji(String(intArrayOf(0x1F48E), 0, 1), listOf("gem"), 27, 10, false),
    GoogleEmoji(String(intArrayOf(0x1F507), 0, 1), listOf("mute"), 29, 61, false),
    GoogleEmoji(String(intArrayOf(0x1F508), 0, 1), listOf("speaker"), 30, 0, false),
    GoogleEmoji(String(intArrayOf(0x1F509), 0, 1), listOf("sound"), 30, 1, false),
    GoogleEmoji(String(intArrayOf(0x1F50A), 0, 1), listOf("loud_sound"), 30, 2, false),
    GoogleEmoji(String(intArrayOf(0x1F4E2), 0, 1), listOf("loudspeaker"), 29, 25, false),
    GoogleEmoji(String(intArrayOf(0x1F4E3), 0, 1), listOf("mega"), 29, 26, false),
    GoogleEmoji(String(intArrayOf(0x1F4EF), 0, 1), listOf("postal_horn"), 29, 38, false),
    GoogleEmoji(String(intArrayOf(0x1F514), 0, 1), listOf("bell"), 30, 12, false),
    GoogleEmoji(String(intArrayOf(0x1F515), 0, 1), listOf("no_bell"), 30, 13, false),
    ...
    GoogleEmoji(String(intArrayOf(0x1F3B7), 0, 1), listOf("saxophone"), 7, 53, false),
    GoogleEmoji(String(intArrayOf(0x1FA97), 0, 1), listOf("accordion"), 55, 17, false),
    GoogleEmoji(String(intArrayOf(0x1F3B8), 0, 1), listOf("guitar"), 7, 54, false),
    GoogleEmoji(String(intArrayOf(0x1F3B9), 0, 1), listOf("musical_keyboard"), 7, 55, false),
    GoogleEmoji(String(intArrayOf(0x1F3BA), 0, 1), listOf("trumpet"), 7, 56, false),
    GoogleEmoji(String(intArrayOf(0x1F3BB), 0, 1), listOf("violin"), 7, 57, false),
    GoogleEmoji(String(intArrayOf(0x1FA95), 0, 1), listOf("banjo"), 55, 15, false),
    GoogleEmoji(String(intArrayOf(0x1F941), 0, 1), listOf("drum_with_drumsticks"), 43, 48, false),
    GoogleEmoji(String(intArrayOf(0x1FA98), 0, 1), listOf("long_drum"), 55, 18, false),
    GoogleEmoji(String(intArrayOf(0x1FA87), 0, 1), listOf("maracas"), 55, 8, false),
    ...
    GoogleEmoji(String(intArrayOf(0x1F50B), 0, 1), listOf("battery"), 30, 3, false),
    ...
    GoogleEmoji(String(intArrayOf(0x1F4F8), 0, 1), listOf("camera_with_flash"), 29, 47, false),
    GoogleEmoji(String(intArrayOf(0x1F4F9), 0, 1), listOf("video_camera"), 29, 48, false),
    ...
    GoogleEmoji(String(intArrayOf(0x1FA94), 0, 1), listOf("diya_lamp"), 55, 14, false),
    GoogleEmoji(String(intArrayOf(0x1F4D4), 0, 1), listOf("notebook_with_decorative_cover"), 29, 11, false),
    GoogleEmoji(String(intArrayOf(0x1F4D5), 0, 1), listOf("closed_book"), 29, 12, false),
    GoogleEmoji(String(intArrayOf(0x1F4D6), 0, 1), listOf("book", "open_book"), 29, 13, false),
    GoogleEmoji(String(intArrayOf(0x1F4D7), 0, 1), listOf("green_book"), 29, 14, false),
    GoogleEmoji(String(intArrayOf(0x1F4D8), 0, 1), listOf("blue_book"), 29, 15, false),
    GoogleEmoji(String(intArrayOf(0x1F4D9), 0, 1), listOf("orange_book"), 29, 16, false),
    GoogleEmoji(String(intArrayOf(0x1F4DA), 0, 1), listOf("books"), 29, 17, false),
    GoogleEmoji(String(intArrayOf(0x1F4D3), 0, 1), listOf("notebook"), 29, 10, false),
  )
}
