...
@Config(manifest = Config.NONE) @RunWith(RobolectricTestRunner.class) public class EmojiUtilsTest {
  ...
  @Before public void setUp() {
    final Emoji emoji1 = new Emoji(CODE_POINT_1, "test", R.drawable.emoji_recent, false);
    final Emoji emoji2 = new Emoji(CODE_POINT_2, "test", R.drawable.emoji_backspace, false);
