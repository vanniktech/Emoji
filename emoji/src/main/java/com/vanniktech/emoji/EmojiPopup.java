...
public final class EmojiPopup {
  ...
  @NonNull
  final int emojiViewBackgroundColor;
  @NonNull
  final int emojiViewIconNormalColor;
  @NonNull
  final int emojiViewIconSelectedColor;
  @NonNull
  final int variantPopupBackgroundColor;
  @NonNull
  ...
  EmojiPopup(@NonNull final View rootView,
             @NonNull final EmojiEditText emojiEditText,
             @Nullable final RecentEmoji recent,
             @Nullable final VariantEmoji variant,
             @NonNull final int emojiViewBackgroundColor,
             @NonNull final int emojiViewIconNormalColor,
             @NonNull final int emojiViewIconSelectedColor,
             @NonNull final int variantPopupBackgroundColor,
    ...
    this.emojiViewBackgroundColor = emojiViewBackgroundColor;
    this.emojiViewIconNormalColor = emojiViewIconNormalColor;
    this.emojiViewIconSelectedColor = emojiViewIconSelectedColor;
    ...
    final OnEmojiLongClickListener longClickListener = new OnEmojiLongClickListener() {
      ...
      public void onEmojiLongClick(@NonNull final EmojiImageView view, @NonNull final Emoji emoji) {
        variantPopup.show(view, emoji, variantPopupBackgroundColor);
      }
    };
    ...
    final EmojiView emojiView = new EmojiView(
            context,
            clickListener,
            longClickListener,
            recentEmoji,
            variantEmoji,
            emojiViewBackgroundColor,
            emojiViewIconNormalColor,
            emojiViewIconSelectedColor,
  ...
  public static final class Builder {
    ...
    @NonNull
    private int emojiViewBackgroundColor;
    @NonNull
    private int emojiViewIconNormalColor;
    @NonNull
    private int emojiViewIconSelectedColor;
    @NonNull
    private int variantPopupBackgroundColor;
    @NonNull
    private int variantIndicatorColor;
    @NonNull
    ...
    @CheckResult
    public Builder setEmojiViewBackgroundColor(@NonNull final int color) {
      emojiViewBackgroundColor = color;
      return this;
    }

    @CheckResult
    public Builder setEmojiViewIconNormalColor(@NonNull final int color) {
      emojiViewIconNormalColor = color;
      return this;
    }

    @CheckResult
    public Builder setEmojiViewIconSelectedColor(@NonNull final int color) {
      emojiViewIconSelectedColor = color;
      return this;
    }

    @CheckResult
    public Builder setVariantPopupBackgroundColor(@NonNull final int color) {
      variantPopupBackgroundColor = color;
      return this;
    }

    @CheckResult
    public Builder setVariantIndicatorColor(@NonNull final int color) {
      variantIndicatorColor = color;
      return this;
    }

    @CheckResult
    public Builder setDividerColor(@NonNull final int color) {
      dividerColor = color;
      return this;
    }
    ...
    public EmojiPopup build(@NonNull final EmojiEditText emojiEditText) {
      ...
      final EmojiPopup emojiPopup = new EmojiPopup(
              rootView,
              emojiEditText,
              recentEmoji,
              variantEmoji,
