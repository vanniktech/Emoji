...
public final class EmojiPopup {
    ...
    final ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        @Override public void onGlobalLayout() {
            ...
            if (heightDifference > Utils.dpToPx(context, MIN_KEYBOARD_HEIGHT)) {
                popupWindow.setHeight(heightDifference + heightOffset);
    ...
    public static final class Builder {
        ...
        @Nullable private int heightOffset = 0;
        ...
        @CheckResult public Builder setHeightOffset(@Nullable final int heightOffset) {
        ...
        @CheckResult public EmojiPopup build(@NonNull final EmojiEditText emojiEditText) {
            ...
            emojiPopup.heightOffset = heightOffset;
            return emojiPopup;
        }
    }
}
