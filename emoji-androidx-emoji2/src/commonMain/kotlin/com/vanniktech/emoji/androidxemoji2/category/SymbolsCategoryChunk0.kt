...
internal object SymbolsCategoryChunk0 {
  internal val EMOJIS: List<AndroidxEmoji2> = listOf(
    AndroidxEmoji2(String(intArrayOf(0x1F3E7), 0, 1), listOf("atm")),
    AndroidxEmoji2(String(intArrayOf(0x1F6AE), 0, 1), listOf("put_litter_in_its_place")),
    AndroidxEmoji2(String(intArrayOf(0x1F6B0), 0, 1), listOf("potable_water")),
    AndroidxEmoji2(String(intArrayOf(0x267F), 0, 1), listOf("wheelchair")),
    AndroidxEmoji2(String(intArrayOf(0x1F6B9), 0, 1), listOf("mens")),
    AndroidxEmoji2(String(intArrayOf(0x1F6BA), 0, 1), listOf("womens")),
    AndroidxEmoji2(String(intArrayOf(0x1F6BB), 0, 1), listOf("restroom")),
    AndroidxEmoji2(String(intArrayOf(0x1F6BC), 0, 1), listOf("baby_symbol")),
    AndroidxEmoji2(String(intArrayOf(0x1F6BE), 0, 1), listOf("wc")),
    AndroidxEmoji2(String(intArrayOf(0x1F6C2), 0, 1), listOf("passport_control")),
    AndroidxEmoji2(String(intArrayOf(0x1F6C3), 0, 1), listOf("customs")),
    ...
    AndroidxEmoji2(String(intArrayOf(0x26D4), 0, 1), listOf("no_entry")),
    AndroidxEmoji2(String(intArrayOf(0x1F6AB), 0, 1), listOf("no_entry_sign")),
    AndroidxEmoji2(String(intArrayOf(0x1F6B3), 0, 1), listOf("no_bicycles")),
    AndroidxEmoji2(String(intArrayOf(0x1F6AD), 0, 1), listOf("no_smoking")),
    AndroidxEmoji2(String(intArrayOf(0x1F6AF), 0, 1), listOf("do_not_litter")),
    AndroidxEmoji2(String(intArrayOf(0x1F6B1), 0, 1), listOf("non-potable_water")),
    AndroidxEmoji2(String(intArrayOf(0x1F6B7), 0, 1), listOf("no_pedestrians")),
    ...
    AndroidxEmoji2(String(intArrayOf(0x1F504), 0, 1), listOf("arrows_counterclockwise")),
    AndroidxEmoji2(String(intArrayOf(0x1F519), 0, 1), listOf("back")),
    AndroidxEmoji2(String(intArrayOf(0x1F51A), 0, 1), listOf("end")),
    AndroidxEmoji2(String(intArrayOf(0x1F51B), 0, 1), listOf("on")),
    AndroidxEmoji2(String(intArrayOf(0x1F51C), 0, 1), listOf("soon")),
    ...
    AndroidxEmoji2(String(intArrayOf(0x1F52F), 0, 1), listOf("six_pointed_star")),
    AndroidxEmoji2(String(intArrayOf(0x1FAAF), 0, 1), listOf("khanda")),
    AndroidxEmoji2(String(intArrayOf(0x2648), 0, 1), listOf("aries")),
    AndroidxEmoji2(String(intArrayOf(0x2649), 0, 1), listOf("taurus")),
    AndroidxEmoji2(String(intArrayOf(0x264A), 0, 1), listOf("gemini")),
    AndroidxEmoji2(String(intArrayOf(0x264B), 0, 1), listOf("cancer")),
    AndroidxEmoji2(String(intArrayOf(0x264C), 0, 1), listOf("leo")),
    AndroidxEmoji2(String(intArrayOf(0x264D), 0, 1), listOf("virgo")),
    AndroidxEmoji2(String(intArrayOf(0x264E), 0, 1), listOf("libra")),
    AndroidxEmoji2(String(intArrayOf(0x264F), 0, 1), listOf("scorpius")),
    AndroidxEmoji2(String(intArrayOf(0x2650), 0, 1), listOf("sagittarius")),
    AndroidxEmoji2(String(intArrayOf(0x2651), 0, 1), listOf("capricorn")),
    AndroidxEmoji2(String(intArrayOf(0x2652), 0, 1), listOf("aquarius")),
    AndroidxEmoji2(String(intArrayOf(0x2653), 0, 1), listOf("pisces")),
    AndroidxEmoji2(String(intArrayOf(0x26CE), 0, 1), listOf("ophiuchus")),
    AndroidxEmoji2(String(intArrayOf(0x1F500), 0, 1), listOf("twisted_rightwards_arrows")),
    ...
    AndroidxEmoji2(String(intArrayOf(0x23EB), 0, 1), listOf("arrow_double_up")),
    ...
    AndroidxEmoji2(String(intArrayOf(0x1F505), 0, 1), listOf("low_brightness")),
    AndroidxEmoji2(String(intArrayOf(0x1F506), 0, 1), listOf("high_brightness")),
    AndroidxEmoji2(String(intArrayOf(0x1F4F6), 0, 1), listOf("signal_strength")),
    AndroidxEmoji2(String(intArrayOf(0x1F6DC), 0, 1), listOf("wireless")),
