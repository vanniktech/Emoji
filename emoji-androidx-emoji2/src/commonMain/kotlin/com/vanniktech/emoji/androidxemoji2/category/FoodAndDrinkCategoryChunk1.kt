...
internal object FoodAndDrinkCategoryChunk1 {
  internal val EMOJIS: List<AndroidxEmoji2> = listOf(
    AndroidxEmoji2(String(intArrayOf(0x1F942), 0, 1), listOf("clinking_glasses"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F943), 0, 1), listOf("tumbler_glass"), false),
    AndroidxEmoji2(String(intArrayOf(0x1FAD7), 0, 1), listOf("pouring_liquid"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F964), 0, 1), listOf("cup_with_straw"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F9CB), 0, 1), listOf("bubble_tea"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F9C3), 0, 1), listOf("beverage_box"), false),
    ...
    AndroidxEmoji2(String(intArrayOf(0x1FAD9), 0, 1), listOf("jar"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F3FA), 0, 1), listOf("amphora"), false),
  )
}
