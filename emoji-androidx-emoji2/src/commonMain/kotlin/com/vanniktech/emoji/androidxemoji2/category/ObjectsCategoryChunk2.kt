...
internal object ObjectsCategoryChunk2 {
  internal val EMOJIS: List<AndroidxEmoji2> = listOf(
    AndroidxEmoji2(String(intArrayOf(0x1FA92), 0, 1), listOf("razor"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F9F4), 0, 1), listOf("lotion_bottle"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F9F7), 0, 1), listOf("safety_pin"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F9F9), 0, 1), listOf("broom"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F9FA), 0, 1), listOf("basket"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F9FB), 0, 1), listOf("roll_of_paper"), false),
    AndroidxEmoji2(String(intArrayOf(0x1FAA3), 0, 1), listOf("bucket"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F9FC), 0, 1), listOf("soap"), false),
    AndroidxEmoji2(String(intArrayOf(0x1FAE7), 0, 1), listOf("bubbles"), false),
    AndroidxEmoji2(String(intArrayOf(0x1FAA5), 0, 1), listOf("toothbrush"), false),
    AndroidxEmoji2(String(intArrayOf(0x1F9FD), 0, 1), listOf("sponge"), false),
    ...
    AndroidxEmoji2(String(intArrayOf(0x1FAA7), 0, 1), listOf("placard"), false),
    AndroidxEmoji2(String(intArrayOf(0x1FAAA), 0, 1), listOf("identification_card"), false),
  )
}
