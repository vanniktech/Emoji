...
public class <%= name %> extends Emoji {
  ...
  public <%= name %>(@NonNull final int[] codePoints, @Nullable final String shortcode, final int x, final int y,
  ...
  public <%= name %>(final int codePoint, @Nullable final String shortcode, final int x, final int y,
                     final boolean isDuplicate) {
