...
public class EmojiOne extends Emoji {
  ...
  public EmojiOne(@NonNull final int[] codePoints, final int x, final int y) {
    super(codePoints, -1);
  ...
  public EmojiOne(final int codePoint, final int x, final int y) {
    super(codePoint, -1);
  ...
  public EmojiOne(final int codePoint, final int x, final int y, final Emoji... variants) {
  ...
  public EmojiOne(@NonNull final int[] codePoints, final int x, final int y, final Emoji... variants) {
