...
public class FacebookEmoji extends Emoji {
  ...
  public FacebookEmoji(@NonNull final int[] codePoints, @Nullable final String shortcode, final int x, final int y,
  ...
  public FacebookEmoji(final int codePoint, @Nullable final String shortcode, final int x, final int y,
                     final boolean isDuplicate) {
