...
internal class SmileysAndPeopleCategory : EmojiCategory {
  ...
  private companion object {
    val ALL_EMOJIS: Array<FacebookEmoji> = CategoryUtils.concatAll(SmileysAndPeopleCategoryChunk0.get(), SmileysAndPeopleCategoryChunk1.get(), SmileysAndPeopleCategoryChunk2.get())
  }
}
