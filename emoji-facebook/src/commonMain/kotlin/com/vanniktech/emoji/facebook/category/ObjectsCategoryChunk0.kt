...
internal object ObjectsCategoryChunk0 {
  internal val EMOJIS: List<FacebookEmoji> = listOf(
    ...
    FacebookEmoji("\ud83d\udc54", listOf("necktie"), 13, 26),
    FacebookEmoji("\ud83d\udc55", listOf("shirt", "tshirt"), 13, 27),
    FacebookEmoji("\ud83d\udc56", listOf("jeans"), 13, 28),
    FacebookEmoji("\ud83e\udde3", listOf("scarf"), 54, 22),
    FacebookEmoji("\ud83e\udde4", listOf("gloves"), 54, 23),
    FacebookEmoji("\ud83e\udde5", listOf("coat"), 54, 24),
    FacebookEmoji("\ud83e\udde6", listOf("socks"), 54, 25),
    FacebookEmoji("\ud83d\udc57", listOf("dress"), 13, 29),
    FacebookEmoji("\ud83d\udc58", listOf("kimono"), 13, 30),
    FacebookEmoji("\ud83e\udd7b", listOf("sari"), 44, 49),
    FacebookEmoji("\ud83e\ude71", listOf("one-piece_swimsuit"), 54, 52),
    FacebookEmoji("\ud83e\ude72", listOf("briefs"), 54, 53),
    FacebookEmoji("\ud83e\ude73", listOf("shorts"), 54, 54),
    FacebookEmoji("\ud83d\udc59", listOf("bikini"), 13, 31),
    FacebookEmoji("\ud83d\udc5a", listOf("womans_clothes"), 13, 32),
    FacebookEmoji("\ud83e\udead", listOf("folding_hand_fan"), 55, 42),
    ...
    FacebookEmoji("\ud83d\udc5f", listOf("athletic_shoe"), 13, 37),
    FacebookEmoji("\ud83e\udd7e", listOf("hiking_boot"), 44, 52),
    FacebookEmoji("\ud83e\udd7f", listOf("womans_flat_shoe"), 44, 53),
    FacebookEmoji("\ud83d\udc60", listOf("high_heel"), 13, 38),
    FacebookEmoji("\ud83d\udc61", listOf("sandal"), 13, 39),
    FacebookEmoji("\ud83e\ude70", listOf("ballet_shoes"), 54, 51),
    FacebookEmoji("\ud83d\udc62", listOf("boot"), 13, 40),
    FacebookEmoji("\ud83e\udeae", listOf("hair_pick"), 55, 43),
    FacebookEmoji("\ud83d\udc51", listOf("crown"), 13, 23),
    FacebookEmoji("\ud83d\udc52", listOf("womans_hat"), 13, 24),
    FacebookEmoji("\ud83c\udfa9", listOf("tophat"), 7, 40),
    ...
    FacebookEmoji("\ud83d\udc8e", listOf("gem"), 27, 11),
    FacebookEmoji("\ud83d\udd07", listOf("mute"), 30, 0),
    FacebookEmoji("\ud83d\udd08", listOf("speaker"), 30, 1),
    FacebookEmoji("\ud83d\udd09", listOf("sound"), 30, 2),
    FacebookEmoji("\ud83d\udd0a", listOf("loud_sound"), 30, 3),
    FacebookEmoji("\ud83d\udce2", listOf("loudspeaker"), 29, 26),
    FacebookEmoji("\ud83d\udce3", listOf("mega"), 29, 27),
    FacebookEmoji("\ud83d\udcef", listOf("postal_horn"), 29, 39),
    FacebookEmoji("\ud83d\udd14", listOf("bell"), 30, 13),
    FacebookEmoji("\ud83d\udd15", listOf("no_bell"), 30, 14),
    ...
    FacebookEmoji("\ud83c\udfb7", listOf("saxophone"), 7, 54),
    FacebookEmoji("\ud83e\ude97", listOf("accordion"), 55, 20),
    FacebookEmoji("\ud83c\udfb8", listOf("guitar"), 7, 55),
    FacebookEmoji("\ud83c\udfb9", listOf("musical_keyboard"), 7, 56),
    FacebookEmoji("\ud83c\udfba", listOf("trumpet"), 7, 57),
    FacebookEmoji("\ud83c\udfbb", listOf("violin"), 7, 58),
    FacebookEmoji("\ud83e\ude95", listOf("banjo"), 55, 18),
    FacebookEmoji("\ud83e\udd41", listOf("drum_with_drumsticks"), 43, 49),
    FacebookEmoji("\ud83e\ude98", listOf("long_drum"), 55, 21),
    FacebookEmoji("\ud83e\ude87", listOf("maracas"), 55, 9),
    ...
    FacebookEmoji("\ud83d\udd0b", listOf("battery"), 30, 4),
