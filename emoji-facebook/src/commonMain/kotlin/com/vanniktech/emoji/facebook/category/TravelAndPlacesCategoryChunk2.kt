...
internal object TravelAndPlacesCategoryChunk2 {
  internal val EMOJIS: List<FacebookEmoji> = listOf(
    FacebookEmoji(
      ...
      y = 33,
      variants = listOf(
        FacebookEmoji("\ud83c\udf29\ufe0f", emptyList(), 5, 33),
      ),
    ),
    FacebookEmoji(
      unicode = "\ud83c\udf2a",
    ...
    FacebookEmoji("\ud83c\udf00", listOf("cyclone"), 4, 56),
    FacebookEmoji("\ud83c\udf08", listOf("rainbow"), 5, 2),
    FacebookEmoji("\ud83c\udf02", listOf("closed_umbrella"), 4, 58),
    FacebookEmoji(
      unicode = "\u2602",
      ...
      y = 10,
      variants = listOf(
        FacebookEmoji("\u2602\ufe0f", emptyList(), 58, 10),
      ),
    ),
    FacebookEmoji("\u2614", listOf("umbrella_with_rain_drops"), 58, 15),
    FacebookEmoji(
      unicode = "\u26f1",
    ...
    FacebookEmoji(
      ...
      y = 11,
      variants = listOf(
        FacebookEmoji("\u2603\ufe0f", emptyList(), 58, 11),
      ),
    ),
    FacebookEmoji("\u26c4", listOf("snowman_without_snow"), 59, 13),
    FacebookEmoji(
      unicode = "\u2604",
    ...
    FacebookEmoji("\ud83d\udd25", listOf("fire"), 30, 29),
    FacebookEmoji("\ud83d\udca7", listOf("droplet"), 28, 23),
    FacebookEmoji("\ud83c\udf0a", listOf("ocean"), 5, 4),
  )
}
