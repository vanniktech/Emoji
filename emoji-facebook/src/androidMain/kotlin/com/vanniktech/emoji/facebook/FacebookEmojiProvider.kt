...
class FacebookEmojiProvider :
  ...
  override fun getIcon(emojiCategory: EmojiCategory): Int = when (emojiCategory) {
    is SmileysAndPeopleCategory -> R.drawable.emoji_facebook_category_smileysandpeople
    is AnimalsAndNatureCategory -> R.drawable.emoji_facebook_category_animalsandnature
    is FoodAndDrinkCategory -> R.drawable.emoji_facebook_category_foodanddrink
    is ActivitiesCategory -> R.drawable.emoji_facebook_category_activities
    is TravelAndPlacesCategory -> R.drawable.emoji_facebook_category_travelandplaces
    is ObjectsCategory -> R.drawable.emoji_facebook_category_objects
    is SymbolsCategory -> R.drawable.emoji_facebook_category_symbols
    is FlagsCategory -> R.drawable.emoji_facebook_category_flags
    else -> error("Unknown $emojiCategory")
  }

  override fun getDrawable(emoji: Emoji, context: Context): Drawable {
    require(emoji is FacebookEmoji) { "emoji needs to be of type FacebookEmoji" }
    val x = emoji.x
    val y = emoji.y
    val key = Point(x, y)
  ...
  private companion object {
    ...
    private val SHEETS = listOf(
      ...
      R.drawable.emoji_facebook_sheet_60,
      R.drawable.emoji_facebook_sheet_61,
    )
