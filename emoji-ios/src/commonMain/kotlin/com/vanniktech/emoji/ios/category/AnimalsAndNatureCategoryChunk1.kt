...
internal object AnimalsAndNatureCategoryChunk1 {
  internal val EMOJIS: List<IosEmoji> = listOf(
    ...
    IosEmoji(String(intArrayOf(0x1FAB1), 0, 1), listOf("worm"), 55, 43),
    IosEmoji(String(intArrayOf(0x1F9A0), 0, 1), listOf("microbe"), 45, 23),
    IosEmoji(String(intArrayOf(0x1F490), 0, 1), listOf("bouquet"), 27, 37),
    IosEmoji(String(intArrayOf(0x1F338), 0, 1), listOf("cherry_blossom"), 5, 48),
    ...
    IosEmoji(String(intArrayOf(0x1F940), 0, 1), listOf("wilted_flower"), 43, 47),
    IosEmoji(String(intArrayOf(0x1F33A), 0, 1), listOf("hibiscus"), 5, 50),
    IosEmoji(String(intArrayOf(0x1F33B), 0, 1), listOf("sunflower"), 5, 51),
    IosEmoji(String(intArrayOf(0x1F33C), 0, 1), listOf("blossom"), 5, 52),
    IosEmoji(String(intArrayOf(0x1F337), 0, 1), listOf("tulip"), 5, 47),
    IosEmoji(String(intArrayOf(0x1FABB), 0, 1), listOf("hyacinth"), 55, 53),
    IosEmoji(String(intArrayOf(0x1F331), 0, 1), listOf("seedling"), 5, 41),
    IosEmoji(String(intArrayOf(0x1FAB4), 0, 1), listOf("potted_plant"), 55, 46),
    IosEmoji(String(intArrayOf(0x1F332), 0, 1), listOf("evergreen_tree"), 5, 42),
    IosEmoji(String(intArrayOf(0x1F333), 0, 1), listOf("deciduous_tree"), 5, 43),
    IosEmoji(String(intArrayOf(0x1F334), 0, 1), listOf("palm_tree"), 5, 44),
    IosEmoji(String(intArrayOf(0x1F335), 0, 1), listOf("cactus"), 5, 45),
    ...
    IosEmoji(String(intArrayOf(0x1F341), 0, 1), listOf("maple_leaf"), 5, 57),
    IosEmoji(String(intArrayOf(0x1F342), 0, 1), listOf("fallen_leaf"), 5, 58),
    IosEmoji(String(intArrayOf(0x1F343), 0, 1), listOf("leaves"), 5, 59),
    IosEmoji(String(intArrayOf(0x1FAB9), 0, 1), listOf("empty_nest"), 55, 51),
    IosEmoji(String(intArrayOf(0x1FABA), 0, 1), listOf("nest_with_eggs"), 55, 52),
    IosEmoji(String(intArrayOf(0x1F344), 0, 1), listOf("mushroom"), 5, 61),
  )
}
