...
internal class FlagsCategory : EmojiCategory {
  ...
  @get:StringRes override val categoryName: Int
    get() = com.vanniktech.emoji.ios.R.string.emoji_ios_category_flags

  override val emojis = ALL_EMOJIS

  private companion object {
    val ALL_EMOJIS: Array<IosEmoji> = CategoryUtils.concatAll(FlagsCategoryChunk0.get(), FlagsCategoryChunk1.get())
  }
}
